		...
		<div id="body">
			<div class="body-top row">
				<div class="row-cell row-left col-xs-12 col-sm-9">
					...
					<?php
						echo form_open('/recipes/categories_manager', array('id' => 'categories_finder_form', 'class' => 'micro-search-form', 'method' => 'get'));
						...
						$_button = cb_draw_button('Find Categories', 'search', null, "form-control admin-form-control", array());
...
FFLD;
				...
				<div class="row-cell row-right col-xs-12 col-sm-3">
					<?php
						echo cb_draw_button('Add New Category', 'plus', '/recipes/category_editor/0', null, array('type' => 'button'));
					?>
				</div>
	...
	<script type="text/javascript">
		function deleteCategory(cid) {
			var dConfirm = confirm('Are You Sure You Want To Delete This Category');
			if(dConfirm == true) {
				$.get(
